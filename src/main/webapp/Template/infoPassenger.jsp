        ...
        <div class="container-fluid d-flex align-items-center">
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    ...
                    <h1 class="display-2 text-white">Passenger and Contact Information...</h1>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-xl-10 order-xl-2 mb-5 mb-xl-0">
                <div class="card card-profile shadow">
                    <div class="card-header text-center border-5 pt-8 pt-md-4 pb-0 pb-md-4">
                        <h2>Please enter your passenger information</h2>
                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="form-group focused">
                                                        ...
                                                        <input type="text" id="input-first-name" class="form-control form-control-alternative" placeholder="Name" name="name">
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div class="form-group focused">
                                                        <label class="form-control-label" for="input-last-name">Surname</label>
                                                        <input type="text" id="input-last-name" class="form-control form-control-alternative" placeholder="Surname" name="surname">
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        <label class="form-control-label" for="input-birthdate">Date of birth</label>
                                                        <input type="date" id="input-email" class="form-control form-control-alternative" name="birthdate">
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div class="form-group focused">
                                                        <label class="form-control-label" for="input-phone">Gender</label>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group focused">
                                                        <label class="form-control-label" for="input-phone">Mobile phone</label>
                                                        <input type="tel" id="input-username" class="form-control form-control-alternative" placeholder="Phone" name="phone">
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div class="form-group focused">
                                                        <label class="form-control-label" for="input-phone">Your TR Identity Number</label>
