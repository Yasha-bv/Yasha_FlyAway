...
<body>
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
        ...
        <a class="navbar-brand text-white " href="../index.jsp">FlyAway</a>
    </nav>
                                ...
                                <div class="col-xs-8 col-sm-8 col-md-8 col-lg-12 col-xs-offset-0 col-sm-offset-0">
                                    <div class="panel panel-primary" style="border-color: #f5f5f5;">
                                        <div class="panel-body">
                                            <div class="columns">
                                             <ul class="price">
                                               <li class="header" style="background-color:#4CAF50">ECONOMY</li>
                                               <li><i class="fas fa-check" style="color: green">&nbsp </i>55x40x20 cm Cabin Luggage</li>
                                               <li><i class="fas fa-check" style="color: green">&nbsp </i>15 kg Luggage</li>
                                               <li style="color:gray"><i class="fas fa-times" style="color: red">&nbsp </i>Seat Selection</li>
                                               <li style="color:gray"><i class="fas fa-times" style="color: red">&nbsp </i>Return/Change right</li>
                                               <li style="color:gray"><i class="fas fa-times" style="color: red">&nbsp </i>Inflight Entertainment</li>
                                           ...
                                           <div class="columns">
                                             <ul class="price">
                                               <li class="header" style="background-color:rgb(220, 73, 126)">ADVANTAGE</li>
                                               <li><i class="fas fa-check" style="color: green">&nbsp </i>55x40x20 cm Cabin Luggage</li>
                                               <li><i class="fas fa-check" style="color: green">&nbsp </i>20 Kg Luggage</li>
                                               <li><i class="fas fa-check" style="color: green">&nbsp </i>Standard Seat Selection</li>
                                               <li style="color:gray"><i class="fas fa-times" style="color: red">&nbsp </i>Return/Change right</li>
                                               <li><i class="fas fa-check" style="color: green">&nbsp </i>Inflight Entertainment</li>
                                           ...
                                           <div class="columns">
                                             <ul class="price">
                                               ...
                                               <li><i class="fas fa-check" style="color: green">&nbsp </i>55x40x20 cm Cabin Luggage</li>
                                               <li><i class="fas fa-check" style="color: green">&nbsp </i>15 Kg Luggage</li>
                                               <li><i class="fas fa-check" style="color: green">&nbsp </i>Your Desired Seat Selection</li>
                                               <li><i class="fas fa-check" style="color: green">&nbsp </i>RIGHT TO RETURN/CHANGE WITHOUT PUNITION</li>
                                               <li><i class="fas fa-check" style="color: green">&nbsp </i>Inflight Entertainment</li>
