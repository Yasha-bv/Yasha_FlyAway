 ...
 <div class="main-content">
  ...
  <nav class="navbar navbar-top navbar-expand-md navbar-dark"
   ...
   <div class="container-fluid">
    <!-- Brand -->
    <img src="Assets/flighticon.png" height="40px"
     style="width: 35px !important" /> <a
     class="navbar-brand text-white " href="index.jsp"> &nbsp
     FlyAway </a>
    <!-- Form -->
    <form
    ...
    <ul class="navbar-nav align-items-center d-none d-md-flex">
     <li class="nav-item dropdown"><a
      class="navbar-brand text-white" href="LogoutServlet"> Exit </a></li>
    </ul>
   </div>
  </nav>
    ...
    <div class="row">
     <div class="col-lg-7 col-md-10">
      ...
      <p class="text-white mt-0 mb-5">This is your profile page.
       Profile and flight information you can manage from here</p>
     </div>
    </div>
   </div>
  </div>
             ...
             <div class="col-lg-6">
              <div class="form-group focused">
               <label class="form-control-label" for="input-last-name">
                Surname </label> <input type="text" id="input-last-name"
                class="form-control form-control-alternative"
             ...
             <div class="col-lg-6">
              <div class="form-group">
               <label class="form-control-label" for="input-email">
                Email </label> <input type="email" id="input-email"
                class="form-control form-control-alternative"
             ...
             <div class="col-lg-6">
              <div class="form-group focused">
               <label class="form-control-label" for="input-phone">
                Phone Number </label> <input type="phone" id="input-username"
                class="form-control form-control-alternative"
     ...
     <div class="card bg-secondary shadow">
      <div class="card-header bg-white border-danger">
       <div class="row align-items-center">
        <img src="Assets/user.png" height="30px"
         style="width: 30px !important" /> <a
         class="navbar-brand text-dark "> &nbsp <%=user.getName()%>
         <%=user.getSurname()%>
        </a>
       </div>
      </div>
      <div class="card-body">
       <div class="text-dark-200">
        <ul class="navbar-nav nav align-items-lg-start" id="navbarNav">
         <li class="nav-item ">
          <h3 class="nav-link fas fa-ticket-alt" href="#">&nbsp
           &nbsp Travel Information</h3>
         </li>
         <li class="nav-item">
          <h3 class="nav-link fas fa-bullhorn" href="#">&nbsp &nbsp
           Campaigns</h3>
         </li>
         <li class="nav-item">
          <h3 class="nav-link text-dark fas fa-user" href="#">
           &nbsp &nbsp Membership Settings</h3>
         </li>
         <li class="nav-item"><a class="btn btn-danger text-white"
          href="index.jsp"> Search Cheap Flights </a></li>

         <li class="nav-item"><br> <a> With FlyAway 0(999)
           999 99 99 for your related requests and questions. You can
           call our free call center. </a></li>
        </ul>
       </div>
      </div>
     </div>
