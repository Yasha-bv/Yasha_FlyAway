              ...
              <li class="nav-item ">
                  <div class="btn-group">
                    ...
                    <div class="dropdown-menu dropdown-menu-right signin text-white">
                        ...
                        <a class="dropdown-item text-white" href="register.jsp">Are you new around here? Register</a>
                        <a class="dropdown-item text-white" href="passwordResetEmail.jsp">Forgot your password?</a>
                      </div>
                  </div>
              </li>
            </ul>
