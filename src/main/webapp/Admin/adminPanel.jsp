                ...
                <div class="row">
                    <div class="col-sm-12">
                        <ul class="list-group mb-4">
                            <li class="list-group-item"><h5>Executive: <%= admin.getName() %>&nbsp<%= admin.getSurname() %></h5></li>
                        ...
                        <div class="card text-center">
                            <div class="card-header">
                                <ul class="nav nav-tabs nav-fill card-header-tabs" id="myTab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true"><i class="fas fa-plane"></i> Add Flight</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="users-list-tab" data-toggle="tab" href="#users-list" role="tab" aria-controls="users" aria-selected="false"><i class="fas fa-user"></i> Registered Users</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="admin-list-tab" data-toggle="tab" href="#admin-list" role="tab" aria-controls="admin" aria-selected="false"><i class="fas fa-users-cog"></i> Managers</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="ticket-sale-tab" data-toggle="tab" href="#ticket-sale" role="tab" aria-controls="ticket" aria-selected="false"><i class="fas fa-ticket-alt"></i> Ticket sales</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="../AdminLogoutServlet"><i class="fas fa-sign-out-alt"></i>Exit</a>
                                    </li>
                                </ul>
                            </div>
                            <div class="tab-content card-body" id="myTabContent">
                                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                            ...
                                            <form class="needs-validation" action="../AddFlightServlet" method="post">
                                                <div class="form-row justify-content-end">
                                                    <div class="col-md-3 mb-3 text-dark">
                                                        <label for="validationTooltip01">From where</label>
                                                        <select class="browser-default custom-select" name="from_location" required>
                                                            <option selected>Select...</option>
                                                            <jsp:include page="../Template/places.jsp"/>
                                                        </select>
                                                    </div>
                                                    <div class="col-md-3 mb-3 text-dark">
                                                        <label for="validationTooltip02">To where</label>
                                                    ...
                                                    <div class="col-md-0 mb-2 m-3 text-white">
                                                        <button type="submit" class="btn btn-danger">Add Flight</button>
                                                    </div>    
                                                </div>
                                            </form>
                                        </div>
                                    ...
                                    <table class="table table-sm table-hover table-bordered table-striped">
                                        <thead class="thead-light">
                                                <tr>
                                                    <th data-toggle="tooltip" data-placement="bottom" title="admin">Flight ID</th>
                                                    <th scope="col">From where</th>
                                                    <th scope="col">To Where</th>
                                                    <th scope="col">Flight Date</th>
                                                    <th scope="col">Departure time</th>
                                                    <th scope="col">Time of arrival</th>
                                                    <th scope="col">ECO Fee</th>
                                                    <th scope="col">ADVANTAGE Fee</th>
                                                    <th scope="col">BUSINESS Fee</th>
                                                    <th></th>                                                
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <c:forEach items="${flightlist}" var="flightlist">
                                                    <tr>
                                                        ...
                                                        <td class="align-middle"><a href="../FlightDeleteServlet?id=<c:out value='${flightlist.id}' />"  onClick="alert('Do you really want to delete this flight?')"  class="btn btn-primary btn-sm"><i class="far fa-trash-alt"></i></a></td>
                                                    </tr>
                                                </c:forEach>
                                            </tbody>
                                    </table>
                                ...
                                <div class="tab-pane fade" id="users-list" role="tabpanel" aria-labelledby="users-list-tab">
                                    <table class="table table-sm table-hover table-bordered table-striped"s>
                                        <thead class="thead-light">
                                            <tr>
                                                <th scope="col" data-toggle="tooltip" data-placement="bottom" title="users">User ID</th>
                                        ...
                                        <tbody>
                                            <c:forEach items="${users}" var="users">
                                                <tr>
                                                    ...
                                                    <td class="align-middle"><a href="../DeleteServlet?id=<c:out value='${users.id}' />"  onClick="alert('Do you really want to delete this user?')"  class="btn btn-primary btn-sm"><i class="far fa-trash-alt"></i></a></td>
                                                </tr>
                                            </c:forEach>
                                        </tbody>
                                    </table>
                            ...
                            <div class="tab-pane fade" id="admin-list" role="tabpanel" aria-labelledby="admin-list-tab">
                                <table class="table table-sm table-hover table-bordered table-striped">
                                    <thead class="thead-light">
                                            <tr>
                                                <th data-toggle="tooltip" data-placement="bottom" title="admin">Executive ID</th>
                                                <th scope="col">Name</th>
                                                <th scope="col">Last Name</th>
                                                <th scope="col">E-mail addres</th>
                                                <th scope="col">Phone number</th>
                                                <th></th>                                                
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <c:forEach items="${adminlist}" var="adminlist">
                                                <tr>
                                                    ...
                                                    <td class="align-middle"><a href="../DeleteServlet?id=<c:out value='${adminlist.id}' />"  onClick="alert('Do you really want to delete this admin?')"  class="btn btn-primary btn-sm"><i class="far fa-trash-alt"></i></a></td>
                                                </tr>
                                            </c:forEach>
                                        </tbody>
                                </table>
